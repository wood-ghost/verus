...
test_verify_one_file_with_options! {
    #[test] crate_inheritance ["no-auto-import-verus_builtin"] => code! {
        #![verifier::auto_reveal_strlit]
        #![verifier::auto_reveal_byteslit]
        use vstd::prelude::*;
        verus! {
...
test_verify_one_file! {
    #[test] module_inheritance verus_code! {
        #[verifier::auto_reveal_strlit(true)]
        #[verifier::auto_reveal_byteslit(true)]
        mod enabled {
            use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] module_and_function_overrides verus_code! {
        #[verifier::auto_reveal_strlit]
        #[verifier::auto_reveal_byteslit]
        mod enabled {
            use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] expression_and_block_enable verus_code! {
        use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] expression_and_block_disable verus_code! {
        use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] inherited_queries verus_code! {
        mod enabled {
            #![verifier::auto_reveal_strlit]
            #![verifier::auto_reveal_byteslit]
            use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] scope_does_not_leak verus_code! {
        use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] opaque_and_closed_specs verus_code! {
        use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] literal_lowering verus_code! {
        use vstd::prelude::*;
...
test_verify_one_file! {
    #[test] invalid_module_setting verus_code! {
        #[verifier::auto_reveal_byteslit(typo)]
        mod invalid {
...
test_verify_one_file! {
    #[test] invalid_expression_setting verus_code! {
        proof fn test() {
